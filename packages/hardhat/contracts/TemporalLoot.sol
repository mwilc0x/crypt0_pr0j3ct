...
contract TemporalLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Bag #',
                        toString(tokenId),
                        '", "description": "Journey Loot is additional randomized adventurer gear generated and stored on chain. Maximum supply is dynamic, increasing at 1/10th of Ethereum\'s block rate. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Journey Loot in any way you want.", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Journey Loot", "JLOOT") Ownable() {}
}
